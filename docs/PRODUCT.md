...
FLYZRDS / Wizard Lizard Flies / Raise a little magic.

An installable Android/iPhone-first PWA is the destination. Foundation uses HTML menus plus a Canvas garden; installation comes in prompt 10. First creature: cute-but-fierce sci-fi long-neck; velociraptor is a later body. Players change the environment and guide a companion instead of directly moving it.
